...
output = convert_to_gold('datasets/RNN_Result/predict.d1.gold_format.txt','datasets/staple-2020/en_pt/test.en_pt.2020-02-20.gold.txt',0)

np.savetxt('datasets/gold_rnn/dataset1.txt', output, fmt='%s',encoding='utf-8')

output = convert_to_gold('datasets/RNN_Result/predict.d2.gold_format.txt','datasets/staple-2020/en_pt/test.en_pt.2020-02-20.gold.txt',0)

np.savetxt('datasets/gold_rnn/dataset2.txt', output, fmt='%s',encoding='utf-8')

output = convert_to_gold('datasets/RNN_Result/predict.d3.gold_format.txt','datasets/staple-2020/en_pt/test.en_pt.2020-02-20.gold.txt',0)

np.savetxt('datasets/gold_rnn/dataset3.txt', output, fmt='%s',encoding='utf-8')
